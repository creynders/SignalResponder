...
* A SignalResponder has a <pre>result</pre> property which contains the result of the process after
completion and is bindable.
* The <pre>status</pre> property contains the current process state expressed as a constant from 
